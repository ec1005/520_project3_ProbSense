...
def solve(true_grid, true_target, start = (0,0)):
	...
	target = Execute.reevaluate_target2(start, prob_eval_grid, known_grid)
	...
	while (True):
		...
		if true_grid[path[pos]] == 0:
			...
			target=Execute.reevaluate_target2(path[pos-1], prob_eval_grid,known_grid)
			...
			target = Execute.reevaluate_target2(path[pos], prob_eval_grid,known_grid)
